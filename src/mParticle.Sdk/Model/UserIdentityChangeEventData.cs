...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserIdentityChangeEventData :  IEquatable<UserIdentityChangeEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserIdentityChangeEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserIdentityChangeEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserIdentityChangeEventData" /> class.
        /// </summary>
        ...
        public UserIdentityChangeEventData(int timestampUnixtimeMs = default(int), string sourceMessageId = default(string), long sessionId = default(long), string sessionUuid = default(string), int sessionStartUnixtimeMs = default(int), int eventStartUnixtimeMs = default(int), Dictionary<string, string> customAttributes = default(Dictionary<string, string>), GeoLocation location = default(GeoLocation), DeviceCurrentState deviceCurrentState = default(DeviceCurrentState), bool isGoalDefined = default(bool), bool lifetimeValueChange = default(bool), string lifetimeValueAttributeName = default(string), string dataConnectionType = default(string), int eventNum = default(int), string viewController = default(string), bool isMainThread = default(bool), string canonicalName = default(string), EventSystemNotificationInfo eventSystemNotificationInfo = default(EventSystemNotificationInfo), UserIdentity _new = default(UserIdentity), UserIdentity old = default(UserIdentity))
        {
        ...
        {
            return this.Equals(input as UserIdentityChangeEventData);
        }

        /// <summary>
        /// Returns true if UserIdentityChangeEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of UserIdentityChangeEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserIdentityChangeEventData input)
        {
            if (input == null)
                return false;
