...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SessionStartEvent :  IEquatable<SessionStartEvent>, IValidatableObject
    {
        /// <summary>
        /// Defines EventType
        /// </summary>
        ...
        /// <param name="eventType">eventType (default to EventTypeEnum.Sessionstart).</param>
        public SessionStartEvent(SessionStartEventData data = default(SessionStartEventData), EventTypeEnum? eventType = EventTypeEnum.Sessionstart)
        {
            this.Data = data;
        ...
        public SessionStartEventData Data { get; set; }
