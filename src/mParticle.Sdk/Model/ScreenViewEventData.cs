...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScreenViewEventData :  IEquatable<ScreenViewEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenViewEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScreenViewEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenViewEventData" /> class.
        /// </summary>
        ...
        public ScreenViewEventData(int timestampUnixtimeMs = default(int), string sourceMessageId = default(string), long sessionId = default(long), string sessionUuid = default(string), int sessionStartUnixtimeMs = default(int), int eventStartUnixtimeMs = default(int), Dictionary<string, string> customAttributes = default(Dictionary<string, string>), GeoLocation location = default(GeoLocation), DeviceCurrentState deviceCurrentState = default(DeviceCurrentState), bool isGoalDefined = default(bool), bool lifetimeValueChange = default(bool), string lifetimeValueAttributeName = default(string), string dataConnectionType = default(string), int eventNum = default(int), string viewController = default(string), bool isMainThread = default(bool), string canonicalName = default(string), EventSystemNotificationInfo eventSystemNotificationInfo = default(EventSystemNotificationInfo), string screenName = default(string), string activityType = default(string), Dictionary<string, string> customFlags = default(Dictionary<string, string>))
        {
        ...
        {
            return this.Equals(input as ScreenViewEventData);
        }

        /// <summary>
        /// Returns true if ScreenViewEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenViewEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenViewEventData input)
        {
            if (input == null)
                return false;
