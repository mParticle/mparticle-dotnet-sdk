...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OptOutEventData :  IEquatable<OptOutEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptOutEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptOutEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptOutEventData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OptOutEventData);
        }

        /// <summary>
        /// Returns true if OptOutEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of OptOutEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptOutEventData input)
        {
            if (input == null)
                return false;
