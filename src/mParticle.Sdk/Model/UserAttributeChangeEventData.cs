...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAttributeChangeEventData :  IEquatable<UserAttributeChangeEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAttributeChangeEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserAttributeChangeEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAttributeChangeEventData" /> class.
        /// </summary>
        ...
        public UserAttributeChangeEventData(int timestampUnixtimeMs = default(int), string sourceMessageId = default(string), long sessionId = default(long), string sessionUuid = default(string), int sessionStartUnixtimeMs = default(int), int eventStartUnixtimeMs = default(int), Dictionary<string, string> customAttributes = default(Dictionary<string, string>), GeoLocation location = default(GeoLocation), DeviceCurrentState deviceCurrentState = default(DeviceCurrentState), bool isGoalDefined = default(bool), bool lifetimeValueChange = default(bool), string lifetimeValueAttributeName = default(string), string dataConnectionType = default(string), int eventNum = default(int), string viewController = default(string), bool isMainThread = default(bool), string canonicalName = default(string), EventSystemNotificationInfo eventSystemNotificationInfo = default(EventSystemNotificationInfo), string userAttributeName = default(string), Object _new = default(Object), Object old = default(Object), bool deleted = default(bool), bool isNewAttribute = default(bool))
        {
        ...
        {
            return this.Equals(input as UserAttributeChangeEventData);
        }

        /// <summary>
        /// Returns true if UserAttributeChangeEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of UserAttributeChangeEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAttributeChangeEventData input)
        {
            if (input == null)
                return false;
