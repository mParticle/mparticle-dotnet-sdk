...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomEventData :  IEquatable<CustomEventData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEventData" /> class.
        /// </summary>
        ...
        public CustomEventData(int timestampUnixtimeMs = default(int), string sourceMessageId = default(string), long sessionId = default(long), string sessionUuid = default(string), int sessionStartUnixtimeMs = default(int), int eventStartUnixtimeMs = default(int), Dictionary<string, string> customAttributes = default(Dictionary<string, string>), GeoLocation location = default(GeoLocation), DeviceCurrentState deviceCurrentState = default(DeviceCurrentState), bool isGoalDefined = default(bool), bool lifetimeValueChange = default(bool), string lifetimeValueAttributeName = default(string), string dataConnectionType = default(string), int eventNum = default(int), string viewController = default(string), bool isMainThread = default(bool), string canonicalName = default(string), EventSystemNotificationInfo eventSystemNotificationInfo = default(EventSystemNotificationInfo), CustomEventTypeEnum customEventType = CustomEventTypeEnum.Other, string eventName = default(string), Dictionary<string, string> customFlags = default(Dictionary<string, string>))
        {
            this.CustomEventType = customEventType;
            // to ensure "eventName" is required (not null)
            this.EventName = eventName ?? throw new ArgumentNullException("eventName is a required property for CustomEventData and cannot be null");
        ...
        {
            return this.Equals(input as CustomEventData);
        }

        /// <summary>
        /// Returns true if CustomEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomEventData input)
        {
            if (input == null)
                return false;
