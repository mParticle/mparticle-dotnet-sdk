...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SessionEndEventData :  IEquatable<SessionEndEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionEndEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionEndEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionEndEventData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SessionEndEventData);
        }

        /// <summary>
        /// Returns true if SessionEndEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionEndEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionEndEventData input)
        {
            if (input == null)
                return false;
