...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SessionStartEventData :  IEquatable<SessionStartEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionStartEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionStartEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionStartEventData" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionStartEventData {\n");
        ...
        {
            return this.Equals(input as SessionStartEventData);
        }

        /// <summary>
        /// Returns true if SessionStartEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionStartEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionStartEventData input)
        {
            if (input == null)
                return false;
