...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BreadcrumbEventData :  IEquatable<BreadcrumbEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BreadcrumbEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BreadcrumbEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BreadcrumbEventData" /> class.
        /// </summary>
        ...
        public BreadcrumbEventData(int timestampUnixtimeMs = default(int), string sourceMessageId = default(string), long sessionId = default(long), string sessionUuid = default(string), int sessionStartUnixtimeMs = default(int), int eventStartUnixtimeMs = default(int), Dictionary<string, string> customAttributes = default(Dictionary<string, string>), GeoLocation location = default(GeoLocation), DeviceCurrentState deviceCurrentState = default(DeviceCurrentState), bool isGoalDefined = default(bool), bool lifetimeValueChange = default(bool), string lifetimeValueAttributeName = default(string), string dataConnectionType = default(string), int eventNum = default(int), string viewController = default(string), bool isMainThread = default(bool), string canonicalName = default(string), EventSystemNotificationInfo eventSystemNotificationInfo = default(EventSystemNotificationInfo), int sessionNumber = default(int), string label = default(string))
        {
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for BreadcrumbEventData and cannot be null");
        ...
        {
            return this.Equals(input as BreadcrumbEventData);
        }

        /// <summary>
        /// Returns true if BreadcrumbEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of BreadcrumbEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BreadcrumbEventData input)
        {
            if (input == null)
                return false;
