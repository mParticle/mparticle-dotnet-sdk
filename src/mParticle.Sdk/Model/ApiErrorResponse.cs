...
namespace mParticle.Sdk.Model
{
    ...
    public partial class ApiErrorResponse :  IEquatable<ApiErrorResponse>, IValidatableObject
    {
        ...
        public ApiErrorResponse(Collection<ApiErrorResponseErrors> errors = default(Collection<ApiErrorResponseErrors>))
        {
            this.Errors = errors;
        }
        ...
        public Collection<ApiErrorResponseErrors> Errors { get; set; }
