...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushRegistrationEventData :  IEquatable<PushRegistrationEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushRegistrationEventData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PushRegistrationEventData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PushRegistrationEventData" /> class.
        /// </summary>
        ...
        public PushRegistrationEventData(int timestampUnixtimeMs = default(int), string sourceMessageId = default(string), long sessionId = default(long), string sessionUuid = default(string), int sessionStartUnixtimeMs = default(int), int eventStartUnixtimeMs = default(int), Dictionary<string, string> customAttributes = default(Dictionary<string, string>), GeoLocation location = default(GeoLocation), DeviceCurrentState deviceCurrentState = default(DeviceCurrentState), bool isGoalDefined = default(bool), bool lifetimeValueChange = default(bool), string lifetimeValueAttributeName = default(string), string dataConnectionType = default(string), int eventNum = default(int), string viewController = default(string), bool isMainThread = default(bool), string canonicalName = default(string), EventSystemNotificationInfo eventSystemNotificationInfo = default(EventSystemNotificationInfo), bool register = default(bool), string registrationToken = default(string))
        {
        ...
        {
            return this.Equals(input as PushRegistrationEventData);
        }

        /// <summary>
        /// Returns true if PushRegistrationEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of PushRegistrationEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushRegistrationEventData input)
        {
            if (input == null)
                return false;
