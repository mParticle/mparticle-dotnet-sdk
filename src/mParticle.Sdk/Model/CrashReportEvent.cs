...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrashReportEvent :  IEquatable<CrashReportEvent>, IValidatableObject
    {
        /// <summary>
        /// Defines EventType
        /// </summary>
        ...
        /// <param name="eventType">eventType (default to EventTypeEnum.Crashreport).</param>
        public CrashReportEvent(CrashReportEventData data = default(CrashReportEventData), EventTypeEnum? eventType = EventTypeEnum.Crashreport)
        {
            this.Data = data;
        ...
        public CrashReportEventData Data { get; set; }
