...
namespace mParticle.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommerceEvent :  IEquatable<CommerceEvent>, IValidatableObject
    {
        /// <summary>
        /// Defines EventType
        /// </summary>
        ...
        /// <param name="eventType">eventType (default to EventTypeEnum.Commerceevent).</param>
        public CommerceEvent(CommerceEventData data = default(CommerceEventData), EventTypeEnum? eventType = EventTypeEnum.Commerceevent)
        {
            this.Data = data;
        ...
        public CommerceEventData Data { get; set; }
