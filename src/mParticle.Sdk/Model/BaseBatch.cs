...
{
    /// <summary>
    /// Abstract, reusable Batch
    /// </summary>
    [DataContract]

    public class BaseBatch : IEquatable<BaseBatch>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Batch" /> class.
        /// </summary>
        /// <param name="baseBatch">the BaseBatch instance to be copied.</param>
        internal BaseBatch(BaseBatch baseBatch) : this(baseBatch.SourceRequestId, baseBatch.Context, baseBatch.DeviceInfo, baseBatch.ApplicationInfo, baseBatch.UserAttributes, baseBatch.DeletedUserAttributes, baseBatch.UserIdentities, baseBatch.Environment, baseBatch.Ip, baseBatch.IntegrationAttributes, baseBatch.PartnerIdentity, baseBatch.SourceInfo, baseBatch.MpDeviceid, baseBatch.AttributionInfo, baseBatch.TimestampUnixtimeMs, baseBatch.BatchId, baseBatch.Mpid, baseBatch.SdkVersion, baseBatch.ConsentState, baseBatch.JobId)
        { }
        ...
        internal string ApiKey
        {
            ...
            set
            {
                Logger.Verbose("Setting Batch ApiKey");
                _apiKey = value;
            }
        }
            ...
            /// <summary>
            /// Convert this object to a Batch
            /// </summary>
            ...
            /// <returns>Boolean</returns>
            public bool Equals(BaseBatch input)
            {
                if (input == null)
                    return false;
